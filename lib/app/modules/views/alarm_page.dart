                ...
                if (snapshot.hasData) {
                  ...
                  return ListView(
                    children: snapshot.data!.map<Widget>((alarm) {
                      var alarmTime = DateFormat('hh:mm aa', 'ru_RU').format(alarm.alarmDateTime!);
                      ...
                      if (_currentAlarms!.length < 5)
                        DottedBorder(
                          ...
                          child: Container(
                            ...
                            child: MaterialButton(
                              ...
                              onPressed: () {
                                _alarmTimeString = DateFormat('HH:mm', 'ru_RU').format(DateTime.now());
                                              ...
                                              TextButton(
                                                onPressed: () async {
                                                  ...
                                                  if (selectedTime != null) {
                                                    ...
                                                    setModalState(() {
                                                      _alarmTimeString = DateFormat('HH:mm', 'ru_Ru').format(selectedDateTime);
                                                    });
                                                  }
                                                },
                                                child: Text(
                        ...
                        Center(
                            child: Text(
                          'Разрешено использовать только 5 сигналов тревоги!',
